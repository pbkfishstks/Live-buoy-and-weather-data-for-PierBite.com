#!/usr/bin/env python3
# PIERBITE probe | 2026-08-21 | port-washington-node-and-station | v1
...
def parse_floats(text):
    """Pull every number out of an OPeNDAP .ascii response."""
    out = []
...
def main():
    print("PIERBITE - Port Washington node & station probe - v1")
